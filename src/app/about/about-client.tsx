 ...
 * Phase 8 split this into a Server wrapper (page.tsx, holds the
 * `metadata` export) and this Client component, which keeps the
 * motion / useReducedMotion logic.
 *
 * Photo placeholder swap: drop /public/about-photo.jpg and replace the
 * inner <div>I</div> with
